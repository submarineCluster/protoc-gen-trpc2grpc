...
type serviceGenerateHelperInterface interface {
	...
	generateUnimplementedServerType(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile,
		service *protogen.Service)
	generateServerFunctions(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile,
		service *protogen.Service, serverType string, serviceDescVar string)
}
...
func (serviceGenerateHelper) generateNewClientDefinitions(g *protogen.GeneratedFile, service *protogen.Service,
	clientName string) {
}

func (serviceGenerateHelper) generateUnimplementedServerType(gen *protogen.Plugin, file *protogen.File,
	g *protogen.GeneratedFile, service *protogen.Service) {
	serverType := service.GoName + "ServerV2"
	mustOrShould := "must"
	...
	for _, method := range service.Methods {
		...
		g.P("return ", statusPackage.Ident("Errorf"), "(", codesPackage.Ident("Unimplemented"), `, "method `,
			method.GoName, ` not implemented")`)
		g.P("}")
	}
	if *requireUnimplemented {
...
func (serviceGenerateHelper) generateServerFunctions(gen *protogen.Plugin, file *protogen.File,
	g *protogen.GeneratedFile, service *protogen.Service, serverType string, serviceDescVar string) {
}
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	filename := file.GeneratedFilenamePrefix + "_trpc2grpc.pb.go"
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	clientName := service.GoName + "ClientV2"
	...
	serviceDescVar := service.GoName + "_ServiceDescV2"
	g.P("func Register", service.GoName, "ServerV2(s ", grpcPackage.Ident("ServiceRegistrar"), ", srv ", serverType, ") {")
...
func genClientMethod(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, method *protogen.Method,
	...
	g.P("func (c *", unexport(service.GoName), "ClientV2) ", clientSignature(g, method), "{")
	if !method.Desc.IsStreamingServer() && !method.Desc.IsStreamingClient() {
...
func genServerMethod(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile,
	method *protogen.Method) string {
	service := method.Parent
	hname := fmt.Sprintf("_%s_%s_HandlerV2", service.GoName, method.GoName)

	if !method.Desc.IsStreamingClient() && !method.Desc.IsStreamingServer() {
		g.P("func ", hname, "(srv interface{}, ctx ", contextPackage.Ident("Context"),
			", dec func(interface{}) error, interceptor ", grpcPackage.Ident("UnaryServerInterceptor"),
			") (interface{}, error) {")
		g.P("in := new(", method.Input.GoIdent, ")")
		g.P("out := new(", method.Output.GoIdent, ")")
		g.P("if err := dec(in); err != nil { return nil, err }")
		g.P("if interceptor == nil { err := srv.(", service.GoName, "ServerV2).", method.GoName, "(ctx, in, out)")
		g.P("return out, err }")
		...
		g.P("rsp := new(", method.Output.GoIdent, ")")
		g.P("err := srv.(", service.GoName, "ServerV2).", method.GoName,
			"(ctx, req.(*", method.Input.GoIdent, ")", ", rsp)")
		g.P("return rsp, err")
		g.P("}")
